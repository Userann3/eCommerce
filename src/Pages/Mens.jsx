...
export default function Mens({addtocart}) {
  ...
  return (
    <>
       ...
       <div className="container border mens-container d-flex justify-content-between p-5 rounded-5 mt-5">
        ...
        <div>
        <h1>Men</h1>
        <p className='fs-5'><Link to={'/'} className='text-secondary'>Home</Link> <CiPlay1 /> <span className='text-primary'> Men</span></p>
        ...
        <div className='mens-img'>
          <img src="https://minimalin-demo.myshopify.com/cdn/shop/collections/collection-banner_4_600x.png?v=1692607334" alt="" />
        </div>
